...
<!-- Rover Mechanical Section-->
<div style="display:flex; gap:20px; margin-bottom:30px; align-items:stretch;">
  <!-- Rover Mechanical Image -->
  <div style="
    flex: 0 0 45%; 
    max-width: 45%; 
    display:flex; 
    ...
    flex-direction:column;
    ">
    <img src="../assets/images/RoverMechanicalOnly.jpg"
      style="width:100%; height:auto; border-radius:8px; border:1px solid #ddd;">
    <p style="text-align:center; font-size:0.9em; color:#666; margin-top:8px">
      Figure 2. Rover Structure on Initial Fabrication
    </p>
  </div>
  <div style="flex:1; min-width:0;">
    <p>
...
<!-- Stewart Platform Independent Operation Section -->
...
<div style="display:flex; gap:20px; margin-bottom:30px; align-items:stretch;">
  ...
  <div style="
    ...
    flex-direction:column;
    ">
    <img src="../assets/images/StewartPlatformIndependentOperation.gif"
      style="width:100%; height:auto; border-radius:8px; border:1px solid #ddd;">
    <p style="text-align:center; font-size:0.9em; color:#666; margin-top:8px">
      Figure 3. Stewart Platform Independent Operation
    </p>
  </div>
</div>
  
<!-- Rover Indepent Operation --> 
...
<div style="display:flex; gap:20px; margin-bottom:30px; align-items:stretch;">
  ...
  <div style="
    ...
    flex-direction:column;
    ">
    <img src="../assets/images/RoverIndependentOperation.gif"
      style="width:100%; height:auto; border-radius:8px; border:1px solid #ddd;">
    <p style="text-align:center; font-size:0.9em; color:#666; margin-top:8px">
      Figure 4. Rover Independent Operation
    </p>
  </div>
...
<div style="display:flex; gap:20px; margin-bottom:30px; align-items:stretch;">
  ...
  <div style="
    ...
    flex-direction:column;
    ">
    <img src="../assets/images/FirstCombinedMotion.gif"
      style="width:100%; height:auto; border-radius:8px; border:1px solid #ddd;">
    <p style="text-align:center; font-size:0.9em; color:#666; margin-top:8px">
      Figure 5. Early Combined Motion
    </p>
  </div>
</div>
...
<div style="display:flex; gap:20px; margin-bottom:30px; align-items:stretch;">
  ...
  <div style="flex:1; min-width:0;">
  <p>
    After the initial combined motion, many further improvements were made to the platform to improve its performance, reliability, and useability. The final portion of this project was then to test a number of control system architectures for the hybrid Stewart platform-rover system and compare their performances. To do this, I reserved a classroom over winter break, set up an OptiTrack motion capture system, integrated the motion capture feedback into the platform backend, and gathered hours of test data to compare all six of the control architectures we tested. Figure 6 depicts this final platform, operating much more smoothly due to component redesigns and software improvements, operating in my motion capture setup (as a note, this gif is sped up, as the wave motion simulated is fairly slow).
    Overall, this was an awesome project - by far my most difficult and in-depth one to date! It was multidisciplinary, requiring me to not just do mechanical design but also embedded systems, control system design, software engineering, and much more. Additionally, I got tons of experience debugging a complex robotic system. I encountered lots of problems trying to get the Stewart platform and rover systems to not just work individually, but also integrate with each other, and then finally integrate with a motion capture system, and spent countless hours doing practical testing, debugging, and repairs after breaking joints and blowing up linear actuators. It was an adventure for sure, but an extremely satisfying one that taught me a lot!
  </p>
  </div>
</div>
